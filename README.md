...
powershell "Start-Process powershell -Verb runAs {wget https://raw.githubusercontent.com/JoelGMSec/
AutoRDPwn/master/AutoRDPwn.ps1  -outfile AutoRDPwn.ps1 ; .\AutoRDPwn.ps1}"
