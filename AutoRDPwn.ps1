...
powershell "Get-Process powershell | sort starttime -Descending | Select -First 1 | Stop-Process -Force" ; cmd /c del %TEMP%\AutoRDPwn.ps1 2> $null ; rm AutoRDPwn.ps1 2> $null
