...
powershell "Get-Process powershell | sort starttime -Descending | Select -Last 1 | Stop-Process -Force" ; cmd /c del %TEMP%\AutoRDPwn.ps1 2> $null ; rm AutoRDPwn.ps1 2> $null
