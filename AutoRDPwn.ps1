...
Start-Process powershell -Verb RunAs -windowstyle hidden {"Get-Process powershell | sort starttime -Descending | Select -Last 1 | Stop-Process -Force" ; rm $env:temp\AutoRDPwn.ps1 2> $null ; rm AutoRDPwn.ps1 2> $null}
